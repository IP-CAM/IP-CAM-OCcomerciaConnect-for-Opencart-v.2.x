...
class ControllerExtensionModuleComerciaConnect extends Controller
{
    ...
    public function index()
    {
        //initial load
        $data = array();
        Util::load()->language('extension/module/comerciaConnect', $data);
        $form = Util::form($data);
        ...
        //actions
        $data['action'] = Util::url()->link('extension/module/comerciaConnect');
        $data['sync_url'] = Util::url()->link('extension/module/comerciaConnect/sync');
        $data['simple_connect_url'] = Util::url()->link('extension/module/comerciaConnect/simpleConnect');
    ...
    public function simpleconnect()
    {
        if (Util::request()->server()->REQUEST_METHOD != 'POST') {
            $data = array();
            Util::load()->language("extension/module/comerciaConnect", $data);
            Util::response()->view("extension/module/comerciaConnect_simpleConnect", $data);
        } else {
            $data = array();
    ...
    function sync()
    {
        ...
        $ccOrderModel = Util::load()->model("extension/comerciaconnect/order");
        $ccProductModel = Util::load()->model("extension/comerciaconnect/product");
        ...
        Util::config()->set("comerciaConnect", 'comerciaConnect_last_sync', time());
        Util::response()->redirect("extension/module/comerciaConnect");
    }
